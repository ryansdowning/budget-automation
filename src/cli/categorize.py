"""CLI for parsing and categorizing PDF statements."""
...
from src.cli.summarize import generate_summary
...
Examples:
  ...
  %(prog)s statement.pdf -o output.csv --summary  # Also generate summary
        """,
    )
        ...
        with Pipeline(
            ...
            if transactions:
                ...
                if args.summary:
                    ...
                    generate_summary(args.output, summary_path, categories)
